...
@Component({
  selector: 'app-restaurent-add-icecreams',
  templateUrl: './restaurent-add-icecreams.component.html',
  styleUrls: ['./restaurent-add-icecreams.component.css']
})
export class RestaurentAddIcecreamsComponent {
  files: any = File;
  constructor(
  ...
  formsubmit() {
    ...
    this.__restaurent_service
      .submit_icecreamitems(this.agroup.value, this.files)
      .subscribe(
        (data) => 
        console.log(data)
