...
@Component({
  selector: 'app-restaurent-add-vegitems',
  templateUrl: './restaurent-add-vegitems.component.html',
  styleUrls: ['./restaurent-add-vegitems.component.css']
})
export class RestaurentAddVegitemsComponent {
  files: any = File;
  constructor(
  ...
  formsubmit() {
    ...
    this.__restaurent_service
      .submit_vegitems(this.agroup.value, this.files)
      .subscribe(
        (data) => 
        console.log(data)
